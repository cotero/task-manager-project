 ...
 * {@link com.liferay.customtools.service.impl.TaskLocalServiceImpl} and is the
 ...
 * @see com.liferay.customtools.service.base.TaskLocalServiceBaseImpl
 * @see com.liferay.customtools.service.impl.TaskLocalServiceImpl
 * @generated
 */
@ProviderType
public class TaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.customtools.service.impl.TaskLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.customtools.model.Task addTask(
	...
	* @return the new task
	*/
	public static com.liferay.customtools.model.Task createTask(long taskId) {
	...
	*/
	public static com.liferay.customtools.model.Task deleteTask(
		com.liferay.customtools.model.Task task) {
	...
	*/
	public static com.liferay.customtools.model.Task deleteTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteTask(taskId);
	}

	public static com.liferay.customtools.model.Task fetchTask(long taskId) {
	...
	*/
	public static com.liferay.customtools.model.Task fetchTaskByUuidAndGroupId(
	...
	* @throws PortalException if a task with the primary key could not be found
	*/
	public static com.liferay.customtools.model.Task getTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.customtools.model.Task getTaskByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static int getTasksByGroupIdCount(long groupId) {
		return getService().getTasksByGroupIdCount(groupId);
	}

	public static int getTasksByUserIdCount(long userId) {
		return getService().getTasksByUserIdCount(userId);
	}
	...
	*/
	public static java.util.List<com.liferay.customtools.model.Task> getTasks(
		int start, int end) {
		return getService().getTasks(start, end);
	}

	public static java.util.List<com.liferay.customtools.model.Task> getTasksByGroupId(
		long groupId) {
		return getService().getTasksByGroupId(groupId);
	}

	public static java.util.List<com.liferay.customtools.model.Task> getTasksByUserId(
		long userId) {
	...
	public static java.util.List<com.liferay.customtools.model.Task> getTasksByUserId(
		...
		return getService().getTasksByUserId(userId, start, end);
	}

	public static java.util.List<com.liferay.customtools.model.Task> getTasksByUserId_Status(
		long userId, int status) {
		return getService().getTasksByUserId_Status(userId, status);
	}

	public static java.util.List<com.liferay.customtools.model.Task> getTasksByUserId_Status(
		long userId, java.lang.String name) {
		return getService().getTasksByUserId_Status(userId, name);
	}
	...
	*/
	public static java.util.List<com.liferay.customtools.model.Task> getTasksByUuidAndCompanyId(
